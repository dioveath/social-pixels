            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  We&apos;re a team of experienced designers and developers that focuses on increasing your revenue. We combine marketing and design to help brands grow in an age of digital transformation.
                </p>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2023 All rights reserved. Created by Social Pixels
            </p>
          </div>
        </div>
